  ...
  return (
    <div>
        ...
        {isOpen && (
          <div>
            <ul className="enseiArea">
              {/* 鎮守府近海 */}
              <li className="enseiAreaElem">
                <p onClick={() => setChinjufuOpen(!chinjufuOpen)}>
                  ☆鎮守府近海
                </p>
              </li>
              {chinjufuOpen && (
              ...
              {/* 南西諸島海域 */}
              <li className="enseiAreaElem">
                <p onClick={() => setNanseisyotouOpen(!nanseisyotouOpen)}>
                  ☆南西諸島海域
                </p>
              </li>
              {nanseisyotouOpen && (
              ...
              {/* 北方海域 */}
              <li className="enseiAreaElem">
                <p onClick={() => setHoppouOpen(!hoppouOpen)}>☆北方海域</p>
              </li>
              {hoppouOpen && (
                <div className="enseiListDiv">
                  <ul className="enseiList">
              ...
              {/* 南西海域 */}
              <li className="enseiAreaElem">
                <p onClick={() => setNanseiOpen(!nanseiOpen)}>☆南西海域</p>
              </li>
              {nanseiOpen && (
                <div className="enseiListDiv">
                  <ul className="enseiList">
              ...
              {/* 西方海域 */}
              <li className="enseiAreaElem">
                <p onClick={() => setSeihouOpen(!seihouOpen)}>☆西方海域</p>
              </li>
              {seihouOpen && (
                <div className="enseiListDiv">
                  <ul className="enseiList">
              ...
              {/* 南方海域 */}
              <li className="enseiAreaElem">
                <p onClick={() => setNanpouOpen(!nanpouOpen)}>☆南方海域</p>
              </li>
              {nanpouOpen && (
                <div className="enseiListDiv">
                  <ul className="enseiList">
      ...
      <div className="form" id="timerList">
        ...
        {timerOpen && (
          <div>
            {!finishText && <p id="enseiplace">{enseiPlace}</p>}
            <p id="timer">
              {hour}時間{minute}分{second}秒
            </p>
          </div>
